...
SECRET_KEY = 'django-insecure-1-yezyegoaw#013%lq+gw1@xq&n04&x4ygfyy(-2c=3b6#00fb'
...
'NAME': 'test_78', #use your database name here at the time of creation
...
# AUTHENTICATION_BACKENDS = ['AuthUser.backend.EmailBackend']
